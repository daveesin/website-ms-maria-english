                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-12 mb-16">
                        ...
                        <div className="text-center md:text-left space-y-4">
                            ...
                            <p className="text-gray-200">Entre em contato e agende sua aula experimental.</p>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center border-t border-white/5 pt-8 gap-6">
                        ...
                        <p className="text-gray-200 text-sm">© 2024 Cultural Bridge Institute - Todos os direitos reservados.</p>
